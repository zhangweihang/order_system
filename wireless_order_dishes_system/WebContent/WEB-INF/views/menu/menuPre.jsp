...
<div class="content">
        ...
        <div class="container-fluid">
            ...
            <div class="span1"></div>
            	<div class="span5">
					<h1>${menu.name}</h1>
					<img src="/SSMPropertys/images/${menulist.pic}" alt="" width="220" height="170">	
               </div>
               <div class="span6">  	
					<h2>
					<span class="label"> 价 格 : </span> 
					<span class="label label-success" >  ${menulist.price}</span>
					</h2>
					<h2>
					...
					<p class="text-success">${menulist.remark}</p>

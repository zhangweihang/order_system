...
<html lang="en">
  <head>
	...
	<script src="/SSMPropertys/js/jquery-1.7.2.min.js" type="text/javascript"></script>
  ...
  <!--<![endif]-->
    ...
    <div class="sidebar-nav">
        ...
        <ul id="dashboard-menu" class="nav nav-list collapse in">
            ...
            <li><a href="/SSMPropertys/grzx.do">个人中心</a></li>
        </ul>
   ...
   <div class="content">
        ...
        <div class="container-fluid">
         ...
         <form id="tab" action="/SSMPropertys/refresh.do" method="post">               
    ...
    <div id="myTabContent" class="tab-content">
      <div class="tab-pane active in" id="home">
        ...
        <label>用户id</label>
        <input name="uid" type="text" value="${usertbl.id}" class="input-xlarge uneditable-input">
        <label>用户名</label>
        <input name="uname"  type="text" value="${usertbl.username}" class="input-xlarge">
        <label>真实姓名</label>
        <input  name="name"  type="text" value="${usertbl.name}" class="input-xlarge">
        <label>性别</label>
        <input name="gender"  type="text" value="${usertbl.gender}" class="input-xlarge">
        <label>权限</label>
        <input name="permission"  type="text" value="${usertbl.permission}" class="input-xlarge">
        <label>备注</label>
        <input name="remark"  type="text" value="${usertbl.remark}" class="input-xlarge">
        
    </form>
      </div>
      <div class="tab-pane fade" id="profile">
    <form id="tab2" action="/SSMPropertys/save.do" method="post">
    	<input type="hidden" name="uname" value="${usertbl.username}">
        <label>新密码</label>

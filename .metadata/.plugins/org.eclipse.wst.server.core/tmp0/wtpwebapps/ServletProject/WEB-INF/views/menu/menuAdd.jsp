...
<div class="content">
        ...
        <div class="header">
            <h1 class="page-title">菜谱</h1>
                ...
                <ul class="breadcrumb">
            <li><a href="/SSMPropertys/menu.do">主页</a> <span class="divider">/</span></li>
        ...
        <div class="container-fluid">
            ...
            <form action="/SSMPropertys/menu.do" method="Get" class="form-horizontal"  enctype="multipart/form-data" >    
            <div class="row-fluid">
               <div class="span7">  	

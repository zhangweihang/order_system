  ...
  <!--<![endif]-->
                ...
                <ul class="nav pull-right">
                    ...
                    <li id="fat-menu" class="dropdown">
                        <a href="#" role="button" class="dropdown-toggle" data-toggle="dropdown">
                            <i class="icon-user"></i>${sname}
                            <i class="icon-caret-down"></i>
                        </a>
                        <ul class="dropdown-menu">
                            <li><a tabindex="-1" href="./home.do" >个人中心</a></li>
                            <li class="divider"></li>
                            <li><a tabindex="-1" href="./exit.do">退出</a></li>
                        </ul>
                    </li>
                </ul>
                <a class="brand" href="/ServletProject/login.do"><span class="first">无线点餐</span> <span class="second">后台</span></a>
        </div>
    </div>
    ...
    <div class="sidebar-nav">
        ...
        <ul id="dashboard-menu" class="nav nav-list collapse in">
            <li><a href="/ServletProject/login.do">报表</a></li>
   ...
   <div class="content">
        ...
        <div class="header">
            ...
            <h1 class="page-title">个人中心</h1>
                ...
                <ul class="breadcrumb">
            <li><a href="/SSMPropertys/home.do?flag=home">主页</a> <span class="divider">/</span></li>
        ...
        <div class="container-fluid">
         ...
         <form id="tab" action="./save.do" method="post">               
    ...
    <div id="myTabContent" class="tab-content">
      <div class="tab-pane active in" id="home">
        ...
        <label>用户id</label>
        <input name="uid" type="text" value="${utbl.id}" class="input-xlarge uneditable-input">
        <label>用户名</label>
        <input name="uname"  type="text" value="${utbl.username}" class="input-xlarge">
        <label>真实姓名</label>
        <input  name="name"  type="text" value="${utbl.name}" class="input-xlarge">
        <label>性别</label>
        <input name="gender"  type="text" value="${utbl.gender}" class="input-xlarge">
        <label>权限</label>
        <input name="permission"  type="text" value="${utbl.permission}" class="input-xlarge">
        <label>备注</label>
        <input name="remark"  type="text" value="${utbl.remark}" class="input-xlarge">
        
    </form>
      </div>
      <div class="tab-pane fade" id="profile">
    <form id="tab2" action="./savePassword.do" method="post">
    	<input type="hidden" name="uname" value="${utbl.username}">
        <label>新密码</label>

...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="/SSMPropertys/bootstrap/css/bootstrap-select.css">
    ...
    <script src="/SSMPropertys/bootstrap/js/bootstrap-select.js"></script>
    <script src="/SSMPropertys/bootstrap/js/bootstrap-file-input.js"></script>
  ...
  <!--<![endif]-->
    ...
    <div class="sidebar-nav">
        ...
        <ul id="dashboard-menu" class="nav nav-list collapse ">
            ...
            <li><a href="/SSMPropertys/home.do?flag=grzx">个人中心</a></li>
        </ul>
        ...
        <ul id="menu-menu" class="nav nav-list collapse in">
            <li ><a href="/SSMPropertys/menu.do?flag=menu">菜谱管理</a></li>
        </ul>
        ...
        <ul id="order-menu" class="nav nav-list collapse">
            <li ><a href="/SSMPropertys/order.do?flag=order">订单管理</a></li>
        </ul>
    </div>
...
<div class="content">
        ...
        <div class="container-fluid">
            ...
            <form action="/SSMPropertys/updatesave.do" accept-charset="utf-8" method="Get" class="form-horizontal"  enctype="multipart/form-data" >    
            <div class="row-fluid">
               <div class="span7">  	
               <input name="id"  id="name" type="hidden" value="${menulist.id}">
					<div class="control-group">
							<label class="control-label" for="names">菜 名</label>
							<div class="controls">
							<input name="name" class="input-xlarge focused" id="names" type="text" value="${menulist.name}">
							</div>
					</div>
					<div class="control-group">
							<label class="control-label" for="price">价 格</label>
							<div class="controls">
							<input name="price" class="input-xlarge focused" id="price" type="text" value="${menulist.price}">
							</div>
					</div>
					<div class="control-group">
					...
					<input id="menutype" type="hidden"  name="menutype" value="${menu.menutypetbl.id}">
					
					<div class="control-group">
							<label class="control-label" for="remark">备 注</label>
							<div class="controls">
							<textarea rows="4" cols="20" name="remark" id="remark">${menulist.remark}</textarea>
							</div>
					</div>
				...
				<div class="span5">
					<div class="fileupload fileupload-new" data-provides="fileupload">
					  <div class="fileupload-new thumbnail" style="width: 220px; height: 170px;"><img src="/SSMPropertys/images/${menulist.pic}" /></div>
					  ...
					  <input type="file" name="photo" value="/SSMPropertys/images/${menulist.pic}" />
					  </span>
